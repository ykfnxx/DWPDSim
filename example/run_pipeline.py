...
def simulation_config() -> SimulationConfig:
    ...
    return SimulationConfig(
        ...
        storage_policy=StoragePolicyConfig(
            ...
            online_tuning=boolean("DWPDSIM_ONLINE_TUNING", "false"),
            feedback_period_ns=int(os.environ.get("DWPDSIM_FEEDBACK_PERIOD_NS", "900000000000")),
            shadow_page_bytes=int(os.environ.get("DWPDSIM_SHADOW_PAGE_BYTES", "4096")),
            shadow_pages_per_block=int(os.environ.get("DWPDSIM_SHADOW_PAGES_PER_BLOCK", "256")),
            shadow_overprovisioning=float(os.environ.get("DWPDSIM_SHADOW_OVERPROVISIONING", "0.07")),
            shadow_slc_nominal_bytes=int(os.environ.get("DWPDSIM_SHADOW_SLC_NOMINAL_BYTES", "0")),
            shadow_tlc_nominal_bytes=int(os.environ.get("DWPDSIM_SHADOW_TLC_NOMINAL_BYTES", "0")),
            reuse_loss_budget=float(os.environ.get("DWPDSIM_REUSE_LOSS_BUDGET", "0.01")),
            min_reuse_blocks=int(os.environ.get("DWPDSIM_MIN_REUSE_BLOCKS", "4096")),
            reuse_ema_scale_blocks=int(os.environ.get("DWPDSIM_REUSE_EMA_SCALE_BLOCKS", "50000")),
            shadow_slc_physical_blocks=int(os.environ.get("DWPDSIM_SHADOW_SLC_PHYSICAL_BLOCKS", "0")),
            shadow_tlc_physical_blocks=int(os.environ.get("DWPDSIM_SHADOW_TLC_PHYSICAL_BLOCKS", "0")),
        ),
